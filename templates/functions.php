...
define( '{%= appNameSlug %}_VERSION', '{%= appVersion %}' );
 ...
 function {%= appNameSlug %}_scripts_styles() {
	...
	wp_enqueue_script( 'vendor', get_template_directory_uri() . "/assets/js/vendor/vendor.js", array(), {%= appNameSlug %}_VERSION, true );

	wp_enqueue_style( 'vendor', get_template_directory_uri() . "/assets/css/vendor.css", array(), {%= appNameSlug %}_VERSION );

	wp_enqueue_script( '{%= appNameSlug %}', get_template_directory_uri() . "/assets/js/theme{$postfix}.js", array('jquery', 'vendor'), {%= appNameSlug %}_VERSION, true );
		
	wp_enqueue_style( '{%= appNameSlug %}', get_template_directory_uri() . "/assets/css/theme{$postfix}.css", array(), {%= appNameSlug %}_VERSION );
 }
